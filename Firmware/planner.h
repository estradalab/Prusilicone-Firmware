...
#ifdef ENABLE_AUTO_BED_LEVELING
void plan_buffer_line(float x, float y, float z, const float &e, const float &e1, float feed_rate);
...
void plan_buffer_line(float x, float y, float z, const float &e, const float &e1, float feed_rate, const float* gcode_start_position = NULL, uint16_t segment_idx = 0);
