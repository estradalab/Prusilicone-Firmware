...
#define FILAMENT_SIZE "22.57_DIA_Silicone"
#define NOZZLE_TYPE "0.51mm"
...
// Steps per unit {X,Y,Z,E,E1}
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,280,280,280}
...
#define NUM_AXIS 5 // The axis order in all axis related arrays is X, Y, Z, E, E1
#define HOMING_FEEDRATE {3000, 3000, 800, 0, 0}  // set the homing speeds (mm/min) // 3000 is also valid for stallGuard homing. Valid range: 2200 - 3000
...
#define DEFAULT_MAX_FEEDRATE                {200, 200, 12, 12, 12}      // (mm/sec)   max feedrate (M203)
#define DEFAULT_MAX_FEEDRATE_SILENT         {100, 100, 12, 12, 12}      // (mm/sec)   max feedrate (M203), silent mode

#define DEFAULT_MAX_ACCELERATION            {1000, 1000, 200, 5000, 5000}  // (mm/sec^2) max acceleration (M201)
#define DEFAULT_MAX_ACCELERATION_SILENT     {960, 960, 200, 5000, 5000}    // (mm/sec^2) max acceleration (M201), silent mode
...
#define MANUAL_FEEDRATE {2700, 2700, 1000, 200, 200}   // set the speeds for manual moves (mm/min)
...
#define TMC2130_USTEPS_E1    16        // microstep resolution for E1 axis
#define TMC2130_INTPOL_XY   1         // extrapolate 256 for XY axes
#define TMC2130_INTPOL_Z    1         // extrapolate 256 for Z axis
#define TMC2130_INTPOL_E    1         // extrapolate 256 for E axis
#define TMC2130_INTPOL_E1    1         // extrapolate 256 for E1 axis
...
#define TMC2130_PWM_GRAD_E1  4         // PWMCONF
#define TMC2130_PWM_AMPL_E1  240       // PWMCONF
#define TMC2130_PWM_AUTO_E1  1         // PWMCONF
#define TMC2130_PWM_FREQ_E1  2         // PWMCONF
...
#define TMC2130_TCOOLTHRS_E1 500
...
#define TMC2130_SG_THRS_E1      3
#define TMC2130_SG_THRS_HOME {3, 3, TMC2130_SG_THRS_Z, TMC2130_SG_THRS_E, TMC2130_SG_THRS_E1}

//new settings is possible for vsense = 1, running current value > 31 set vsense to zero and shift both currents by 1 bit right (Z axis only)
#define TMC2130_CURRENTS_H {16, 20, 35, 30, 30}  // default holding currents for all axes
#define TMC2130_CURRENTS_FARM 36             // E 805 mA peak for ECool/farm mode
#define TMC2130_CURRENTS_R {16, 20, 35, 30, 30}  // default running currents for all axes
#define TMC2130_CURRENTS_R_HOME {8, 10, 20, 18, 18}  // homing running currents for all axes
